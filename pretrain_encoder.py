...
class ResNet(nn.Module):
    ...
    def forward(self,x):
        feat_list = []
        out1 = F.relu(self.bn1(self.conv1(x))) ; feat_list.append(out1)
        out2 = self.block1(out1) ; feat_list.append(out2)
        out3 = self.block2(out2) ; feat_list.append(out3)
        out4 = self.block3(out3) ; feat_list.append(out4)
        out5 = self.block4(out4) ; feat_list.append(out5)
